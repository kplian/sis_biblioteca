...
class MODCategoria extends MODbase{
	...
	function listarCategoria(){
		...
		$this->procedimiento='bibl.ft_categoria_sel';
		$this->transaccion='BIBLIO_CAT_SEL';
	...
	function insertarCategoria(){
		...
		$this->procedimiento='bibl.ft_categoria_ime';
		$this->transaccion='BIBLIO_CAT_INS';
	...
	function modificarCategoria(){
		//Definicion de variables para ejecucion del procedimiento
		$this->procedimiento='bibl.ft_categoria_ime';
		$this->transaccion='BIBLIO_CAT_MOD';
		$this->tipo_procedimiento='IME';
	...
	function eliminarCategoria(){
		//Definicion de variables para ejecucion del procedimiento
		$this->procedimiento='bibl.ft_categoria_ime';
		$this->transaccion='BIBLIO_CAT_ELI';
		$this->tipo_procedimiento='IME';
