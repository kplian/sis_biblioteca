...
Phx.vista.Categoria=Ext.extend(Phx.gridInterfaz,{
	...
	Atributos:[
		...
		},
		{
			config:{
				...
				qtip:'Introduzca una categoria con la que sera identificada la herramienta.',
				emptyText: 'Ingrese una categoria...',
				allowBlank: false,
				anchor: '80%',
				gwidth: 200,
				maxLength:50
				...
				type:'TextField',
				filters:{pfiltro:'cat.nombre_categoria',type:'string'},
				id_grupo:1,
				grid:true,
				egrid:true,
				form:true
	...
	tam_pag:50,	
	title:'Categoria',
	ActSave:'../../sis_biblioteca/control/Categoria/insertarCategoria',
	ActDel:'../../sis_biblioteca/control/Categoria/eliminarCategoria',
	ActList:'../../sis_biblioteca/control/Categoria/listarCategoria',
